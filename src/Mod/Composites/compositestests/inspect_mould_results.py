...
def _print_report(report: dict):
    ...
    print(f"accessibility_summary: {result.get('accessibility_summary')}")
    print(f"profile_summary: {result.get('profile_summary')}")
    print(f"geometric_accuracy_summary: {result.get('geometric_accuracy_summary')}")
