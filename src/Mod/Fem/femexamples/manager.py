...
def run_all():
    ...
    run_example("assembly_linkbody_free_dynamics_compound_materials", run_solver=True)
    ...
    run_example("failure_stress_exposure_factor_demo", run_solver=False)
    ...
    run_example("material_orthotropic_shell_lcs", run_solver=True)
...
def setup_all():
    ...
    run_example("assembly_linkbody_free_dynamics_compound_materials")
    ...
    run_example("failure_stress_exposure_factor_demo")
    ...
    run_example("material_orthotropic_shell_lcs")
